"""
ESER training loop using episode reward selection.

This loop stores high-return episodes in long-term memory and periodically
repeats actions from selected valuable episodes.
"""
...
def policy_based_train(
    ...
    """Train a policy-based agent with ESER repetition."""
    ...
    for total_step_counter in range(int(max_steps_training)):
        ...
        if total_step_counter < max_steps_exploration or explore:
            ...
            if episode_timesteps >= len(crucial_actions):
                ...
                print(
                    ...
                    f"{RN - number_of_crusial_episodes} time"
                )
        ...
        if (
            ...
            and memory.long_term_memory.get_length() > 0
        ):
